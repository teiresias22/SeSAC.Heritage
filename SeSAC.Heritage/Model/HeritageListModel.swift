...
class Heritage_List: Object {
    ...
    convenience init(sn: String, no: String, ccmaName: String, crltsnoNm: String, ccbaMnm1: String, ccbaMnm2: String, ccbaCtcdNm: String, ccsiName: String, ccbaKdcd: String, ccbaCtcd: String, ccbaAsno: String, longitude: String, latitude: String){
        self.init()
        self.sn = sn
        self.no = no
